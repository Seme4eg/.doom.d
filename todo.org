...
** TODO gnus? [[file:~/.emacs.d/.local/straight/repos/evil-collection/modes/gnus/evil-collection-gnus.el][evil-collection-gnus.el]]
** TODO telega evil collection check -> less in telega.org
** TODO any way to make some 'prev/next in history' funcs in [[file:~/.emacs.d/.local/straight/repos/evil-collection/modes/helpful/evil-collection-helpful.el][helpful]]
