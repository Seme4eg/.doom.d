...
(def-doom-theme
  ...
  ((bg         `(,(ewal-get-color 'background  0) "black"   "black"))
   ...
   (base5      `(,(ewal-get-color 'comment    -0.3) "#525252" "brightblack"))
   (base6      `(,(ewal-get-color 'background  0.4) "#6b6b6b" "brightblack"))
   (base7      `(,(ewal-get-color 'background  0.7) "#979797" "brightblack"))
   (base8      `(,(ewal-get-color 'background  0.9) "#dfdfdf" "white"))

   (grey       base4)
   (red        `(,(ewal-get-color 'red       0)   "#ff6655" "red"))
   (orange     `(,(ewal-get-color 'red       0.2) "#dd8844" "brightred"))
   (green      `(,(ewal-get-color 'green     0.2) "#99bb66" "green"))
   (teal       `(,(ewal-get-color 'green     0.4) "#44b9b1" "brightgreen"))
