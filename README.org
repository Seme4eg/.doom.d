...
* Packages
- _git_: prefix ~SPC-g~, read all commands there, you won't miss anything
...
- _Nov_ [[https://depp.brause.cc/nov.el/][#docs]] [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/nov/evil-collection-nov.el][evil-collectoin-nov.el]]
...
*** Rss
just locate file =evil-collection-elfeed.el= for the bindings
