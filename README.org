...
3 ways of setting buffer/dir local variables:
- =.dir-locals.el= file with something like ~((yaml-mode . ((apheleia-inhibit .
  t))))~
- adding ~# -*- apheleia-inhibit: t -*-~ to top of the file
- or that to the bottom:
  #+begin_src
# Local Variables:
# apheleia-inhibit: t
# End:
