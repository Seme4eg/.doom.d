...
*IMPORTANT* - [[file:~/.config/emacs/docs/getting_started.org::*Looking up documentation and state from within Emacs][Looking up documentation and HELP]] in *ANY* possible way e.g. /vars,
...
* Shortcuts
:PROPERTIES:
:Sources: [[file:~/.config/emacs/modules/config/default/+evil-bindings.el][+evil-bindings.el]], [[https://github.com/hlissner/doom-emacs/blob/96bea9e9ad4f3e3412472fa0f26a19d19be66a1a/modules/config/default/%2Bbindings.el][bindings.el]], [[file:~/.config/emacs/modules/editor/evil/config.el::;;; Keybinds][evil/config.el]]
:END:
...
_Leader mode map links_: *TAB* [[elisp:(helpful-variable 'doom-leader-workspace-map)][workspace]] ([[file:~/.config/emacs/modules/ui/workspaces/README.org::*Commands & Keybindings][doom]] & C-t - new, gt/T), *b* [[elisp:(helpful-variable 'doom-leader-buffer-map)][buffers]], *f* [[elisp:(helpful-variable
...
* Packages
** git [[file:~/.config/emacs/modules/tools/magit/README.org::*Plugins][#plugins]] [[elisp:(helpful-variable 'doom-leader-git-map)][#modemap]]
...
** evil [[file:~/.config/emacs/modules/editor/evil/README.org::*Features][#features]]
...
- *evil-mc* - ~gz ..~. Which-key available. For some reason kbds in
  [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/evil-mc/evil-collection-evil-mc.el][evil-collection-evil-mc.el]] ain't there.
...
** Development
[[https://github.com/emacs-lsp/lsp-mode][lsp]] - [[https://emacs-lsp.github.io/lsp-mode/tutorials/CPP-guide/][tutorial]], ~SPC c l~ - prefix ([[file:~/.config/emacs/modules/tools/lsp/README.org::*Features][lsp doom features]]).

[[https://github.com/hlissner/doom-snippets][snippets and how to use / write them]]
- :i  [C-tab] #'aya-expand
- :nv [C-tab] #'aya-create

*** eval [[file:~/.config/emacs/modules/tools/eval/README.org::*Features][#features]]
...
*** Languages
- JS [[file:~/.config/emacs/modules/lang/javascript/README.org::*Commands][#commands]] (js2-mode / tide / js2-refactor / skewer-mode / npm-mode), and
...
***** [[file:~/.config/emacs/.local/straight/repos/go-mode.el/go-guru.el][Go-guru]]* (code navigation)
...
***** debug
[[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/debug/evil-collection-debug.el][evil-collction-debug]] + :
...
** Navigation
*** window-select [[file:~/.config/emacs/modules/ui/window-select/README.org::*Description][#description]] ~spc w w~
...
- vertico [[file:~/.config/emacs/modules/completion/vertico/README.org::*Vertico keybindings][#kbds]] [[elisp:(helpful-variable 'vertico-map)][#modemap]], also check [[file:~/.config/emacs/modules/completion/vertico/README.org::*Orderless filtering][Orderless filtering]] , ~C-SPC~ embark-preview
- syntax (flycheck) [[file:~/.config/emacs/modules/checkers/syntax/README.org::*Features][#features]] [[elisp:(helpful-variable 'flycheck-mode-map)][#modemap]] [[elisp:(helpful-variable 'flycheck-error-list-mode-map)][#list modemap]]
...
*** spell (dictionary) [[file:~/.config/emacs/modules/checkers/spell/README.org::+TITLE: checkers/spell][#source]] [[https://gitlab.com/ideasman42/emacs-spell-fu][spell-fu]]
...
** Info [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/info/evil-collection-info.el][evil-collection-info.el]]
#+begin_comment
...
- [[file:~/.config/emacs/modules/ui/popup/README.org::*Commands][popup]]:
...
- [[file:~/.config/emacs/modules/tools/editorconfig/README.org::*Features][editorconfig]]
...
- Nov [[https://depp.brause.cc/nov.el/][#docs]] [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/nov/evil-collection-nov.el][evil-collectoin-nov.el]]

Some other modes: [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/xref/evil-collection-xref.el][evil-collection-xref.el]],
...
*** Xwidget [[file:~/.config/emacs/.local/straight/repos/evil-collection/modes/xwidget/evil-collection-xwidget.el][evil-collection-xwidget.el]]
...
*** IRC [[file:~/.config/emacs/modules/app/irc/README.org::*An IRC Client in Emacs][#kbds]] ~SPC m~
#+NAME: what is IRC
#+begin_comment
...
~SPC~ .. j, k, r
* Todos
- fix [[file:~/dotfiles/.config/emacs/.local/straight/repos/evil-collection/modes/diff-hl/evil-collection-diff-hl.el][evil-collection]] not working properly in 'diff-hl' popup buffers
- when running emacs as client can't set DISPLAY var to ':0', it always is
  'wayland-1', which i suppose is a reason why mu4e fails on pinentry step. For
  now switched back to non-client emacs and disabled systemd daemon untill i
  will find solution.
