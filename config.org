...
(after! emms
  ...
  (setq!
   emms-source-file-default-directory "~/Wu Na/"
   emms-player-mpd-music-directory "~/Wu Na/"
...
(map! :leader
      (:prefix ("l" . "listen")
       ...
       :desc "Browser / open close" "l" #'emms-smart-browse
       ...
       ;; maybe another binding for emms-player-mpd-update-directory
       :desc "Update all + cache" "R" #'emms-player-mpd-update-all-reset-cache
       :desc "Restart mpd music daemon" "r" #'+emms/mpd-restart-music-daemon
       :desc "Restart mpd music daemon" "u" #'+emms/mpc-update-database
