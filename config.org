...
(after! go-ts-mode
  ...
  (setq-hook! 'go-ts-mode-hook +format-with '(goimports golines lsp))
...
;; (after! forge
;;   (push '("gitlab.medpoint24.ru"
;;           "gitlab.medpoint24.ru/api/v4"
;;           "gitlab.medpoint24.ru"
...
(defun my/slack ()
  ...
  (unless (boundp 'slack-team)
    (slack-register-team
     :name "MUSE"
     :token (+pass-get-field "main/work/mg/slack" "token")
     :cookie (+pass-get-field "main/work/mg/slack" "cookie")
     :full-and-display-names t
     :visible-threads t
     :default t
     :subscribed-channels nil)
    (oset slack-current-team enterprise-token (+pass-get-field "main/work/mg/slack" "enterprise-token"))
    (slack-start))
  (slack-im-select))
...
#+begin_src elisp
;; (setq sambanova_key (+pass-get-field "main/ai/sambanova" "apikey")
;;       gemini_key (+pass-get-secret "main/ai/gemini")
;;       deepseek_key (+pass-get-field "main/ai/deepseek" "apikey"))
...
(after! gptel
  (gptel-make-openai "Sambanova"
    ...
    :stream t
    :key (lambda () (+pass-get-field "main/ai/sambanova" "apikey"))
    :models '(DeepSeek-R1))
  (gptel-make-gemini "Gemini"
    :key (lambda () (+pass-get-secret "main/ai/gemini"))
    :stream t)
  (gptel-make-deepseek "DeepSeek"
    :key (lambda () (+pass-get-field "main/ai/deepseek" "apikey"))
    :stream t)
  (setq gptel-default-mode 'org-mode
        ...
        gptel-api-key (lambda () (+pass-get-field "main/ai/openai" "apikey"))
...
(after! circe
  ...
  (setq circe-network-options
    `(("Libera Chat"
       :nick "earthian"
       :sasl-username ,(+pass-get-user "main/social/irc/libera.chat")
       :sasl-password ,(+pass-get-secret "main/social/irc/libera.chat"))
